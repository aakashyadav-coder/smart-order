...
// Lightweight Drawer built on vaul-style sheet behavior using a portal
// For full vaul integration: npm i vaul — already installed
...
const DrawerContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      <div className="mx-auto mt-4 h-1.5 w-16 rounded-full bg-border" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
