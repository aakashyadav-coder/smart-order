/**
 * KitchenLoginPage — Brand-themed dark login for kitchen staff
          ...
          {step === 2 && (
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div>
                ...
                <button type="button" onClick={() => { setDigits(Array(6).fill('')); handleSendOtp({ preventDefault: () => { } }) }}
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-6 md:hidden">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center"
                  ...
                  <FaUtensils size={16} color="white" />
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <FaEnvelope className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={14} />
                  <input
                    type="email" autoComplete="email" placeholder="your@email.com" required
