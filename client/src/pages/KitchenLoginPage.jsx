/**
 * KitchenLoginPage — shadcn/ui refactor
...
import { FaEye, FaEyeSlash, FaUtensils, FaChevronLeft } from 'react-icons/fa'
        ...
        <div className="px-8 py-7 space-y-5">
          ...
          {step === 1 && (
            <form onSubmit={handleSendOtp} className="space-y-5">
              <div className="space-y-1.5">
                <Label htmlFor="kfp-email">Email address</Label>
                <div className="relative">
                  <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input id="kfp-email" type="email" required autoComplete="email"
          ...
          {step === 3 && (
            <form onSubmit={handleResetPassword} className="space-y-5">
              <div className="space-y-1.5">
                <Label htmlFor="kfp-newpw">New Password</Label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input id="kfp-newpw" type={showNewPw ? 'text' : 'password'} required minLength={6}
              ...
              <div className="space-y-1.5">
                <Label htmlFor="kfp-confirmpw">Confirm Password</Label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input id="kfp-confirmpw" type={showNewPw ? 'text' : 'password'} required
      ...
      <div className="relative w-full max-w-4xl rounded-3xl overflow-hidden bg-white border border-gray-200 shadow-[0_32px_80px_rgba(0,0,0,0.25)]">
        <div className="grid md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col items-center justify-center p-12 relative bg-white border-r border-gray-100">
            ...
            <img src="/images/smart.png" alt="Kitchen login" className="relative w-full max-w-lg h-auto object-contain" />
          </div>
          ...
          <div className="px-8 py-12 sm:px-12 bg-gray-50">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-400">Kitchen staff portal</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <Label htmlFor="kitchen-email">Email address</Label>
                <div className="relative">
                  <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input id="kitchen-email" type="email" autoComplete="email" placeholder="your@email.com" required
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input id="kitchen-password" type={showPw ? 'text' : 'password'} autoComplete="current-password"
                    placeholder="••••••••" required className="pl-10 pr-10 bg-white"
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <a href="/owner/login" className="text-xs text-brand-600 hover:text-brand-700 transition-colors">
                Owner portal →
              </a>
            </div>
          </div>
